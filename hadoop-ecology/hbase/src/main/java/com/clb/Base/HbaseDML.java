...
public class HbaseDML {
    ...
    public void testManyPuts() throws Exception {
        ...
        //获取一个操作指定表的操作对象
        for (int a = 1; a <= 10; a++) {
            Table testHbase = conn.getTable(TableName.valueOf("hid0101_his_cache_xh:test_" + a));
            ArrayList<Put> puts = new ArrayList<Put>();
            for (int i = 1; i < 1000; i++) {
                Put put = new Put(Bytes.toBytes(String.valueOf(i)));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("id"), Bytes.toBytes(String.valueOf(i)));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("name"), Bytes.toBytes("Harden_" + i));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("other_id"), Bytes.toBytes(String.valueOf(random(random, 1, 10000000))));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("sex1"), Bytes.toBytes("boy1"));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("sex2"), Bytes.toBytes("boy2"));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("sex3"), Bytes.toBytes("boy3"));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("sex4"), Bytes.toBytes("boy4"));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("sex5"), Bytes.toBytes("boy5"));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("sex6"), Bytes.toBytes("boy6"));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("sex7"), Bytes.toBytes("boy7"));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("isdeleted"), Bytes.toBytes("0"));
                put.addColumn(Bytes.toBytes("info"), Bytes.toBytes("lastupdatedttm"), Bytes.toBytes(sdf.format(new Date())));
                puts.add(put);
            ...
            testHbase.put(puts);
            testHbase.close();
            System.out.println("******成功插入hid0101_his_cache_xh:test_" + a);
        }
        conn.close();
