...
public class InfluxDBUtil {
    ...
    private static String openurl = "http://192.168.0.115:8086";//连接地址
    private static String username = "xiahu";//用户名
    private static String password = "xiahu";//密码
    private static String database = "ogg_monitor";//数据库
...
//   influxDB.createDB(database);
    ...
    public void createRetentionPolicy() {
        String command =
                String.format("CREATE RETENTION POLICY \"%s\" ON \"%s\" DURATION %s REPLICATION %s DEFAULT", "defalut", database, "30d", 1);
        this.query(command);
    }
    ...
    public static void main(String[] args) {
        ...
        InfluxDBUtil influxDB;

        influxDB = InfluxDBUtil.setUp();
        Map<String, String> tags = new HashMap<>();
        Map<String, Object> fields = new HashMap<>();
        tags.put("TAG_NAME", "his");
        fields.put("TAG_VALUE", 1);
